...
const typeColors: Record<string, { bg: string; text: string; icon: string }> = {
  product_pending: { bg: "bg-amber-50", text: "text-amber-600", icon: "📦" },
  review_pending: { bg: "bg-blue-50", text: "text-blue-600", icon: "💬" },
  creator_verification: { bg: "bg-accent-soft", text: "text-accent", icon: "🔐" },
};
            ...
            return (
              ...
              >
                <div className="flex gap-4">
                  ...
                  {notif.type === "product_pending" && notif.productId && (
                    <Link
                      href="/admin/produits"
                  ...
                  {notif.type === "review_pending" && notif.productId && (
                    <Link
                      href="/admin/avis"
                      className="shrink-0 text-accent text-sm font-medium hover:opacity-80 h-fit"
                    >
                  ...
                  {notif.type === "creator_verification" && (
                    <Link
