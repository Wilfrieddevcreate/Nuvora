    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-soft">
        ...
        <ul className="divide-y divide-border">
          {products.map((p) => (
            <li key={p.slug} className="flex flex-col gap-3 p-4 sm:grid sm:grid-cols-[auto_1fr_100px_100px_80px_60px] sm:items-center sm:gap-4 sm:px-5 sm:py-4">
              {/* Cover mini */}
